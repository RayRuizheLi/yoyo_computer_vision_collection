...
video = cv.VideoCapture("../input_videos/mono_colour_yoyo.MP4")
...
cv.namedWindow('Colour Sliders', cv.WINDOW_NORMAL)
...
cv.moveWindow('Colour Picker', -600, -600)

# Create the sub window for displaying original image 
cv.namedWindow('Original', cv.WINDOW_NORMAL)
cv.moveWindow('Original', -600, -600)
