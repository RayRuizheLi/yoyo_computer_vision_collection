...
# Read input video
video = cv.VideoCapture("../input_videos/yoyo2.mp4")
...
if save_tracking_video:
    tracked_video = cv.VideoWriter('../output_videos/tracking_video.mp4', cv.VideoWriter_fourcc(*'mp4v'),fps, size)
if save_effect_video:
    effect_video = cv.VideoWriter('../output_videos/effect_video.mp4', cv.VideoWriter_fourcc(*'mp4v'),fps, size)
if save_score_effect_video:
    score_effect_video = cv.VideoWriter('../output_videos/score_effect_video.mp4', cv.VideoWriter_fourcc(*'mp4v'),fps, size)
